...
PARAM$semillas <- c(100999, 229751, 527123, 700127, 995051)
...
for (vmax_depth in c( 5, 6, 7, 8, 9)) {
  for (vmin_split in c(1500, 1200, 1000, 800, 600, 400, 200, 100, 50)) {
    for (vcp in c(-1,-0.75, -0.5, -0.25)) {
      for (vmin_bucket in c(1200,1000, 800, 600, 400, 200)) {
