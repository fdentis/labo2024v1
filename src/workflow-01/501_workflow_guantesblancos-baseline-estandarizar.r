...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_estandarizar", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_estandarizar", "DT0001_BL_estandarizar" )

  DR_drifting_guantesblancos( "DR0001_BL_estandarizar", "CA0001_BL_estandarizar" )
  FE_historia_guantesblancos( "FE0001_BL_estandarizar", "DR0001_BL_estandarizar" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_estandarizar", "FE0001_BL_estandarizar" )

  HT_tuning_guantesblancos( "HT0001_BL_estandarizar", "TS0001_BL_estandarizar" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_estandarizar", c("HT0001_BL_estandarizar","TS0001_BL_estandarizar") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_estandarizar", "FE0001_BL_estandarizar" )

  HT_tuning_guantesblancos( "HT0002_BL_estandarizar", "TS0002_BL_estandarizar" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_estandarizar", c("HT0002_BL_estandarizar", "TS0002_BL_estandarizar") )
...
corrida_guantesblancos_202109( "gb01_BL_estandarizar" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_estandarizar" )
