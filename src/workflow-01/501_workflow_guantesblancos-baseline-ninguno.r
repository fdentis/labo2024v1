...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_ninguno", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_ninguno", "DT0001_BL_ninguno" )

  DR_drifting_guantesblancos( "DR0001_BL_ninguno", "CA0001_BL_ninguno" )
  FE_historia_guantesblancos( "FE0001_BL_ninguno", "DR0001_BL_ninguno" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_ninguno", "FE0001_BL_ninguno" )

  HT_tuning_guantesblancos( "HT0001_BL_ninguno", "TS0001_BL_ninguno" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_ninguno", c("HT0001_BL_ninguno","TS0001_BL_ninguno") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_ninguno", "FE0001_BL_ninguno" )

  HT_tuning_guantesblancos( "HT0002_BL_ninguno", "TS0002_BL_ninguno" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_ninguno", c("HT0002_BL_ninguno", "TS0002_BL_ninguno") )
...
corrida_guantesblancos_202109( "gb01_BL_ninguno" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_ninguno" )
