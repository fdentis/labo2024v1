...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001deflacion", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001deflacion", "DT0001deflacion" )

  DR_drifting_guantesblancos( "DR0001deflacion", "CA0001deflacion" )
  FE_historia_guantesblancos( "FE0001deflacion", "DR0001deflacion" )

  TS_strategy_guantesblancos_202109( "TS0001deflacion", "FE0001deflacion")

  HT_tuning_guantesblancos( "HT0001deflacion", "TS0001deflacion" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001deflacion", c("HT0001deflacion","TS0001deflacion") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002deflacion", "FE0001deflacion" )

  HT_tuning_guantesblancos( "HT0002deflacion", "TS0002deflacion" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002deflacion", c("HT0002deflacion", "TS0002deflacion") )
...
corrida_guantesblancos_202109( "gb01deflacion" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02deflacion" )
