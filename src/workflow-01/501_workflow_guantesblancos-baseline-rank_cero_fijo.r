...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_rank_cero_fijo", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_rank_cero_fijo", "DT0001_BL_rank_cero_fijo" )

  DR_drifting_guantesblancos( "DR0001_BL_rank_cero_fijo", "CA0001_BL_rank_cero_fijo" )
  FE_historia_guantesblancos( "FE0001_BL_rank_cero_fijo", "DR0001_BL_rank_cero_fijo" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_rank_cero_fijo", "FE0001_BL_rank_cero_fijo" )

  HT_tuning_guantesblancos( "HT0001_BL_rank_cero_fijo", "TS0001_BL_rank_cero_fijo" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_rank_cero_fijo", c("HT0001_BL_rank_cero_fijo","TS0001_BL_rank_cero_fijo") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_rank_cero_fijo", "FE0001_BL_rank_cero_fijo" )

  HT_tuning_guantesblancos( "HT0002_BL_rank_cero_fijo", "TS0002_BL_rank_cero_fijo" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_rank_cero_fijo", c("HT0002_BL_rank_cero_fijo", "TS0002_BL_rank_cero_fijo") )
...
corrida_guantesblancos_202109( "gb01_BL_rank_cero_fijo" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_rank_cero_fijo" )
