...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001cero", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001cero", "DT0001cero" )

  DR_drifting_guantesblancos( "DR0001cero", "CA0001cero" )
  FE_historia_guantesblancos( "FE0001cero", "DR0001cero" )

  TS_strategy_guantesblancos_202109( "TS0001cero", "FE0001cero" )

  HT_tuning_guantesblancos( "HT0001cero", "TS0001cero" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001cero", c("HT0001cero","TS0001cero") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002cero", "FE0001cero" )

  HT_tuning_guantesblancos( "HT0002cero", "TS0002cero" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002cero", c("HT0002cero", "TS0002cero") )
...
corrida_guantesblancos_202109( "gb01cero" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02cero" )
