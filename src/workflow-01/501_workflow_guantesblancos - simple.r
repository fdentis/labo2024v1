...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001simple", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001simple", "DT0001simple" )

  DR_drifting_guantesblancos( "DR0001simple", "CA0001simple" )
  FE_historia_guantesblancos( "FE0001simple", "DR0001simple" )

  TS_strategy_guantesblancos_202109( "TS0001simple", "FE0001simple")

  HT_tuning_guantesblancos( "HT0001simple", "TS0001simple" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001simple", c("HT0001simple","TS0001simple") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002simple", "FE0001simple" )

  HT_tuning_guantesblancos( "HT0002simple", "TS0002simple" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002simple", c("HT0002simple", "TS0002simple") )
...
corrida_guantesblancos_202109( "gb01simple" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02simple" )
