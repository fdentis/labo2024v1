...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_rank_simple", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_rank_simple", "DT0001_BL_rank_simple" )

  DR_drifting_guantesblancos( "DR0001_BL_rank_simple", "CA0001_BL_rank_simple" )
  FE_historia_guantesblancos( "FE0001_BL_rank_simple", "DR0001_BL_rank_simple" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_rank_simple", "FE0001_BL_rank_simple" )

  HT_tuning_guantesblancos( "HT0001_BL_rank_simple", "TS0001_BL_rank_simple" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_rank_simple", c("HT0001_BL_rank_simple","TS0001_BL_rank_simple") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_rank_simple", "FE0001_BL_rank_simple" )

  HT_tuning_guantesblancos( "HT0002_BL_rank_simple", "TS0002_BL_rank_simple" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_rank_simple", c("HT0002_BL_rank_simple", "TS0002_BL_rank_simple") )
...
corrida_guantesblancos_202109( "gb01_BL_rank_simple" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_rank_simple" )
