...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001ninguno", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001ninguno", "DT0001ninguno" )

  DR_drifting_guantesblancos( "DR0001ninguno", "CA0001ninguno" )
  FE_historia_guantesblancos( "FE0001ninguno", "DR0001ninguno" )

  TS_strategy_guantesblancos_202109( "TS0001ninguno", "FE0001ninguno")

  HT_tuning_guantesblancos( "HT0001ninguno", "TS0001ninguno" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001ninguno", c("HT0001ninguno","TS0001ninguno") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002ninguno", "FE0001ninguno" )

  HT_tuning_guantesblancos( "HT0002ninguno", "TS0002ninguno" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002ninguno", c("HT0002ninguno", "TS0002ninguno") )
...
corrida_guantesblancos_202109( "gb01ninguno" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02ninguno" )
