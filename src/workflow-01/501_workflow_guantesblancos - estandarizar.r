...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001estandarizar", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001estandarizar", "DT0001estandarizar" )

  DR_drifting_guantesblancos( "DR0001estandarizar", "CA0001estandarizar" )
  FE_historia_guantesblancos( "FE0001estandarizar", "DR0001estandarizar" )

  TS_strategy_guantesblancos_202109( "TS0001estandarizar", "FE0001estandarizar")

  HT_tuning_guantesblancos( "HT0001estandarizar", "TS0001estandarizar" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001estandarizar", c("HT0001estandarizar","TS0001estandarizar") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002estandarizar", "FE0001estandarizar" )

  HT_tuning_guantesblancos( "HT0002estandarizar", "TS0002estandarizar" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002estandarizar", c("HT0002estandarizar", "TS0002estandarizar") )
...
corrida_guantesblancos_202109( "gb01estandarizar" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02estandarizar" )
