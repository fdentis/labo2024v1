...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BL_deflacion", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BL_deflacion", "DT0001_BL_deflacion" )

  DR_drifting_guantesblancos( "DR0001_BL_deflacion", "CA0001_BL_deflacion" )
  FE_historia_guantesblancos( "FE0001_BL_deflacion", "DR0001_BL_deflacion" )

  TS_strategy_guantesblancos_202109( "TS0001_BL_deflacion", "FE0001_BL_deflacion" )

  HT_tuning_guantesblancos( "HT0001_BL_deflacion", "TS0001_BL_deflacion" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BL_deflacion", c("HT0001_BL_deflacion","TS0001_BL_deflacion") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BL_deflacion", "FE0001_BL_deflacion" )

  HT_tuning_guantesblancos( "HT0002_BL_deflacion", "TS0002_BL_deflacion" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BL_deflacion", c("HT0002_BL_deflacion", "TS0002_BL_deflacion") )
...
corrida_guantesblancos_202109( "gb01_BL_deflacion" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BL_deflacion" )
