...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$kaggle$envios_desde <-  13500L
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_entrega_rank_usd", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_entrega_rank_usd", "DT0001_entrega_rank_usd" )

  DR_drifting_guanteblancos( "DR0001_entrega_rank_usd", "CA0001_entrega_rank_usd" )
  FE_historia_guantesblancos( "FE0001_entrega_rank_usd", "DR0001_entrega_rank_usd" )

  TS_strategy_guantesblancos_202109( "TS0001_entrega_rank_usd", "FE0001_entrega_rank_usd" )

  HT_tuning_guantesblancos( "HT0001_entrega_rank_usd", "TS0001_entrega_rank_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_entrega_rank_usd", c("HT0001_entrega_rank_usd","TS0001_entrega_rank_usd") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_entrega_rank_usd", "FE0001_entrega_rank_usd" )

  HT_tuning_guantesblancos( "HT0002_entrega_rank_usd", "TS0002_entrega_rank_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_entrega_rank_usd", c("HT0002_entrega_rank_usd", "TS0002_entrega_rank_usd") )
...
corrida_guantesblancos_202109( "gb01_entrega_rank_usd" )
