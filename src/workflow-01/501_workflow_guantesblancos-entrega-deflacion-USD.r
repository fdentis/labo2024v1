...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_entrega_deflacion_usd", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_entrega_deflacion_usd", "DT0001_entrega_deflacion_usd" )

  DR_drifting_guanteblancos( "DR0001_entrega_deflacion_usd", "CA0001_entrega_deflacion_usd" )
  FE_historia_guantesblancos( "FE0001_entrega_deflacion_usd", "DR0001_entrega_deflacion_usd" )

  TS_strategy_guantesblancos_202109( "TS0001_entrega_deflacion_usd", "FE0001_entrega_deflacion_usd" )

  HT_tuning_guantesblancos( "HT0001_entrega_deflacion_usd", "TS0001_entrega_deflacion_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_entrega_deflacion_usd", c("HT0001_entrega_deflacion_usd","TS0001_entrega_deflacion_usd") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_entrega_deflacion_usd", "FE0001_entrega_deflacion_usd" )

  HT_tuning_guantesblancos( "HT0002_entrega_deflacion_usd", "TS0002_entrega_deflacion_usd" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_entrega_deflacion_usd", c("HT0002_entrega_deflacion_usd", "TS0002_entrega_deflacion_usd") )
...
corrida_guantesblancos_202109( "gb01_entrega_deflacion_usd" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "gb02_entrega_deflacion_usd" )
